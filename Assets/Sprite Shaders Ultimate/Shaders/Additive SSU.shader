...
Shader "Sprite Shaders Ultimate/Additive SSU"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			float MyCustomExpression16_g11730( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float3 MyCustomExpression115_g11767( float3 In, float3 From, float3 To, float Fuzziness, float Range )
			{
			...
			float MyCustomExpression16_g11790( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float2 MyCustomExpression10_g11865( float2 UV, int Width, int Height, float Tile, float2 Invert )
			{
			...
			float MyCustomExpression16_g11880( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			v2f vert( appdata_t IN  )
			{
				...
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g11900 = ( ( sin( ( temp_output_8_0_g11900 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g11900 );
				#else
				float2 staticSwitch4_g11900 = temp_output_2_0_g11900;
				#endif
				#ifdef _ENABLEVIBRATE_ON
				float temp_output_30_0_g11901 = temp_output_8_0_g11900;
				float3 rotatedValue21_g11901 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g11901 * _VibrateRotation ) );
				float2 staticSwitch6_g11900 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g11901 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g11901).xy ) + staticSwitch4_g11900 );
				#else
				float2 staticSwitch6_g11900 = staticSwitch4_g11900;
				#endif
				#ifdef _ENABLESINESCALE_ON
				float2 staticSwitch10_g11900 = ( staticSwitch6_g11900 + ( (IN.vertex.xyz).xy * ( ( ( sin( ( _SineScaleFrequency * temp_output_8_0_g11900 ) ) + 1.0 ) * 0.5 ) * _SineScaleFactor ) ) );
				#else
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float linValue16_g11719 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchDistortionSpeed * shaderTime237 ) ) * _GlitchDistortionScale ) ).r;
				...
				float2 staticSwitch62 = ( staticSwitch59 + ( ( localMyCustomExpression16_g11719 - 0.5 ) * _GlitchDistortion * glitchFade152 ) );
				#else
				float2 staticSwitch62 = staticSwitch59;
				#endif
				float2 temp_output_1_0_g11720 = staticSwitch62;
				float2 temp_output_26_0_g11720 = shaderPosition235;
				float temp_output_25_0_g11720 = shaderTime237;
				#ifdef _ENABLEUVDISTORT_ON
				...
				float staticSwitch29_g11727 = ( _UVDistortFade * ( tex2DNode3_g11728.r * tex2DNode3_g11728.a ) );
				#else
				...
				#endif
				#ifdef _ENABLESQUEEZE_ON
				float2 temp_output_1_0_g11726 = staticSwitch5_g11720;
				float2 staticSwitch7_g11720 = ( temp_output_1_0_g11726 + ( ( temp_output_1_0_g11726 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g11726 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) );
				#else
				float2 staticSwitch7_g11720 = staticSwitch5_g11720;
				#endif
				#ifdef _ENABLESINEROTATE_ON
				float3 rotatedValue36_g11725 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g11720 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g11720 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				float2 staticSwitch9_g11720 = (rotatedValue36_g11725).xy;
				#else
				float2 staticSwitch9_g11720 = staticSwitch7_g11720;
				#endif
				#ifdef _ENABLEUVROTATE_ON
				float3 rotatedValue8_g11724 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g11720 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g11720 * _UVRotateSpeed * UNITY_PI ) );
				float2 staticSwitch16_g11720 = (rotatedValue8_g11724).xy;
				#else
				float2 staticSwitch16_g11720 = staticSwitch9_g11720;
				#endif
				#ifdef _ENABLEUVSCROLL_ON
				float2 staticSwitch14_g11720 = ( ( _UVScrollSpeed * temp_output_25_0_g11720 ) + staticSwitch16_g11720 );
				#else
				float2 staticSwitch14_g11720 = staticSwitch16_g11720;
				#endif
				#ifdef _ENABLEPIXELATE_ON
				float2 appendResult35_g11722 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 MultFactor30_g11722 = ( ( _PixelatePixelDensity * ( appendResult35_g11722 / _PixelatePixelsPerUnit ) ) * ( 1.0 / max( _PixelateFade , 1E-05 ) ) );
				float2 clampResult46_g11722 = clamp( ( floor( ( MultFactor30_g11722 * ( staticSwitch14_g11720 + ( float2( 0.5,0.5 ) / MultFactor30_g11722 ) ) ) ) / MultFactor30_g11722 ) , float2( 0,0 ) , float2( 1,1 ) );
				float2 staticSwitch4_g11720 = clampResult46_g11722;
				#else
				float2 staticSwitch4_g11720 = staticSwitch14_g11720;
				#endif
				#ifdef _ENABLEUVSCALE_ON
				float2 staticSwitch24_g11720 = ( ( ( staticSwitch4_g11720 - _UVScalePivot ) / _UVScaleScale ) + _UVScalePivot );
				#else
				float2 staticSwitch24_g11720 = staticSwitch4_g11720;
				#endif
				float2 temp_output_1_0_g11731 = staticSwitch24_g11720;
				#ifdef _ENABLEWIGGLE_ON
				float temp_output_7_0_g11731 = ( sin( ( _WiggleFrequency * ( temp_output_26_0_g11720.y + ( _WiggleSpeed * temp_output_25_0_g11720 ) ) ) ) * _WiggleOffset * _WiggleFade );
				#ifdef _WIGGLEFIXEDGROUNDTOGGLE_ON
				float staticSwitch18_g11731 = ( temp_output_7_0_g11731 * temp_output_1_0_g11731.y );
				#else
				float staticSwitch18_g11731 = temp_output_7_0_g11731;
				#endif
				float2 appendResult12_g11731 = (float2(staticSwitch18_g11731 , 0.0));
				float2 staticSwitch13_g11731 = ( temp_output_1_0_g11731 + appendResult12_g11731 );
				#else
				float2 staticSwitch13_g11731 = temp_output_1_0_g11731;
				#endif
				float2 temp_output_484_0 = staticSwitch13_g11731;
				...
				#endif
				#ifdef _SPRITESHEETFIX_ON
				float2 break14_g11732 = staticSwitch485;
				float2 break11_g11732 = float2( 0,0 );
				...
				#endif
				#ifdef _PIXELPERFECTUV_ON
				float2 appendResult7_g11733 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 staticSwitch427 = ( originalUV460 + ( floor( ( ( staticSwitch371 - uvAfterPixelArt450 ) * appendResult7_g11733 ) ) / appendResult7_g11733 ) );
				#else
				float2 staticSwitch427 = staticSwitch371;
				#endif
				float2 finalUV146 = staticSwitch427;
				float2 temp_output_1_0_g11734 = finalUV146;
				#ifdef _ENABLESMOOTHPIXELART_ON
				sampler2D tex3_g11735 = _MainTex;
				float4 textureTexelSize3_g11735 = _MainTex_TexelSize;
				float2 uvs3_g11735 = temp_output_1_0_g11734;
				float4 localtexturePointSmooth3_g11735 = texturePointSmooth( tex3_g11735 , textureTexelSize3_g11735 , uvs3_g11735 );
				float4 staticSwitch8_g11734 = localtexturePointSmooth3_g11735;
				#else
				float4 staticSwitch8_g11734 = tex2D( _MainTex, temp_output_1_0_g11734 );
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float temp_output_10_0_g11736 = ( _GaussianBlurOffset * _GaussianBlurFade * 0.005 );
				float temp_output_2_0_g11746 = temp_output_10_0_g11736;
				...
				float2 temp_output_7_0_g11736 = temp_output_1_0_g11734;
				float2 temp_output_1_0_g11746 = ( temp_output_7_0_g11736 + ( temp_output_10_0_g11736 * float2( 1,1 ) ) );
				...
				float temp_output_2_0_g11737 = temp_output_10_0_g11736;
				float2 appendResult16_g11737 = (float2(temp_output_2_0_g11737 , 0.0));
				float2 appendResult25_g11739 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11739 = ( appendResult16_g11737 * appendResult25_g11739 );
				float2 temp_output_1_0_g11737 = ( temp_output_7_0_g11736 + ( temp_output_10_0_g11736 * float2( -1,1 ) ) );
				float2 temp_output_1_0_g11739 = temp_output_1_0_g11737;
				float2 appendResult17_g11737 = (float2(0.0 , temp_output_2_0_g11737));
				float2 appendResult25_g11738 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11738 = ( appendResult17_g11737 * appendResult25_g11738 );
				float2 temp_output_1_0_g11738 = temp_output_1_0_g11737;
				float temp_output_2_0_g11743 = temp_output_10_0_g11736;
				float2 appendResult16_g11743 = (float2(temp_output_2_0_g11743 , 0.0));
				float2 appendResult25_g11745 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11745 = ( appendResult16_g11743 * appendResult25_g11745 );
				float2 temp_output_1_0_g11743 = ( temp_output_7_0_g11736 + ( temp_output_10_0_g11736 * float2( -1,-1 ) ) );
				float2 temp_output_1_0_g11745 = temp_output_1_0_g11743;
				float2 appendResult17_g11743 = (float2(0.0 , temp_output_2_0_g11743));
				float2 appendResult25_g11744 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11744 = ( appendResult17_g11743 * appendResult25_g11744 );
				float2 temp_output_1_0_g11744 = temp_output_1_0_g11743;
				float temp_output_2_0_g11740 = temp_output_10_0_g11736;
				float2 appendResult16_g11740 = (float2(temp_output_2_0_g11740 , 0.0));
				float2 appendResult25_g11742 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11742 = ( appendResult16_g11740 * appendResult25_g11742 );
				float2 temp_output_1_0_g11740 = ( temp_output_7_0_g11736 + ( temp_output_10_0_g11736 * float2( 1,-1 ) ) );
				float2 temp_output_1_0_g11742 = temp_output_1_0_g11740;
				float2 appendResult17_g11740 = (float2(0.0 , temp_output_2_0_g11740));
				float2 appendResult25_g11741 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11741 = ( appendResult17_g11740 * appendResult25_g11741 );
				float2 temp_output_1_0_g11741 = temp_output_1_0_g11740;
				float4 staticSwitch3_g11734 = ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11748 + temp_output_1_0_g11748 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11748 + temp_output_1_0_g11748 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11747 + temp_output_1_0_g11747 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11747 + temp_output_1_0_g11747 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11739 + temp_output_1_0_g11739 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11739 + temp_output_1_0_g11739 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11738 + temp_output_1_0_g11738 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11738 + temp_output_1_0_g11738 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11744 + temp_output_1_0_g11744 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11744 + temp_output_1_0_g11744 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11742 + temp_output_1_0_g11742 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11742 + temp_output_1_0_g11742 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) ) ) ) * 0.0625 );
				#else
				float4 staticSwitch3_g11734 = staticSwitch8_g11734;
				#endif
				#ifdef _ENABLESHARPEN_ON
				float2 temp_output_1_0_g11749 = temp_output_1_0_g11734;
				float4 tex2DNode4_g11749 = tex2D( _MainTex, temp_output_1_0_g11749 );
				float temp_output_2_0_g11750 = _SharpenOffset;
				...
				float4 break22_g11749 = ( tex2DNode4_g11749 - ( ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11752 + temp_output_1_0_g11752 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11752 + temp_output_1_0_g11752 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11751 + temp_output_1_0_g11751 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11751 + temp_output_1_0_g11751 ) ) ) ) / 4.0 ) - tex2DNode4_g11749 ) * ( _SharpenFactor * _SharpenFade ) ) );
				float clampResult23_g11749 = clamp( break22_g11749.a , 0.0 , 1.0 );
				float4 appendResult24_g11749 = (float4(break22_g11749.r , break22_g11749.g , break22_g11749.b , clampResult23_g11749));
				float4 staticSwitch12_g11734 = appendResult24_g11749;
				#else
				float4 staticSwitch12_g11734 = staticSwitch3_g11734;
				#endif
				float4 temp_output_471_0 = staticSwitch12_g11734;
				#ifdef _VERTEXTINTFIRST_ON
				float4 temp_output_1_0_g11753 = temp_output_471_0;
				float4 appendResult8_g11753 = (float4(( (temp_output_1_0_g11753).rgb * (IN.color).rgb ) , temp_output_1_0_g11753.a));
				float4 staticSwitch354 = appendResult8_g11753;
				#else
				float4 staticSwitch354 = temp_output_471_0;
				#endif
				float4 originalColor191 = staticSwitch354;
				float4 temp_output_1_0_g11754 = originalColor191;
				float4 temp_output_1_0_g11755 = temp_output_1_0_g11754;
				float2 temp_output_7_0_g11754 = finalUV146;
				#ifdef _ENABLESMOKE_ON
				float2 temp_output_43_0_g11755 = temp_output_7_0_g11754;
				float2 temp_cast_15 = (_SmokeNoiseScale).xx;
				float linValue16_g11756 = tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g11755 ) * temp_cast_15 ) ).r;
				float localMyCustomExpression16_g11756 = MyCustomExpression16_g11756( linValue16_g11756 );
				float clampResult28_g11755 = clamp( ( ( ( localMyCustomExpression16_g11756 - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g11755 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				float3 lerpResult34_g11755 = lerp( (temp_output_1_0_g11755).rgb , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g11755 ) * _SmokeDarkEdge ));
				float4 appendResult31_g11755 = (float4(lerpResult34_g11755 , ( clampResult28_g11755 * _SmokeAlpha * temp_output_1_0_g11755.a )));
				float4 staticSwitch2_g11754 = appendResult31_g11755;
				#else
				float4 staticSwitch2_g11754 = temp_output_1_0_g11754;
				#endif
				#ifdef _ENABLECUSTOMFADE_ON
				float4 temp_output_1_0_g11757 = staticSwitch2_g11754;
				float2 temp_output_57_0_g11757 = temp_output_7_0_g11754;
				float4 tex2DNode3_g11757 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g11757 );
				float linValue16_g11758 = tex2D( _UberNoiseTexture, ( temp_output_57_0_g11757 * _CustomFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11758 = MyCustomExpression16_g11758( linValue16_g11758 );
				float clampResult37_g11757 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g11757.r + ( localMyCustomExpression16_g11758 * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g11757 = (float4((temp_output_1_0_g11757).rgb , ( temp_output_1_0_g11757.a * pow( clampResult37_g11757 , ( _CustomFadeSmoothness / max( tex2DNode3_g11757.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				float4 staticSwitch3_g11754 = appendResult13_g11757;
				#else
				float4 staticSwitch3_g11754 = staticSwitch2_g11754;
				#endif
				float4 temp_output_1_0_g11759 = staticSwitch3_g11754;
				#ifdef _ENABLECHECKERBOARD_ON
				float4 temp_output_1_0_g11760 = temp_output_1_0_g11759;
				float2 appendResult4_g11760 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 temp_output_44_0_g11760 = ( appendResult4_g11760 * _CheckerboardTiling * 0.5 );
				float2 break12_g11760 = step( ( ceil( temp_output_44_0_g11760 ) - temp_output_44_0_g11760 ) , float2( 0.5,0.5 ) );
				float4 appendResult42_g11760 = (float4(( (temp_output_1_0_g11760).rgb * min( ( _CheckerboardDarken + abs( ( -break12_g11760.x + break12_g11760.y ) ) ) , 1.0 ) ) , temp_output_1_0_g11760.a));
				float4 staticSwitch2_g11759 = appendResult42_g11760;
				#else
				float4 staticSwitch2_g11759 = temp_output_1_0_g11759;
				#endif
				#ifdef _ENABLEFLAME_ON
				float2 temp_output_75_0_g11761 = finalUV146;
				float linValue16_g11762 = tex2D( _UberNoiseTexture, ( ( ( shaderTime237 * _FlameSpeed ) + temp_output_75_0_g11761 ) * _FlameNoiseScale ) ).r;
				float localMyCustomExpression16_g11762 = MyCustomExpression16_g11762( linValue16_g11762 );
				float saferPower57_g11761 = abs( max( ( temp_output_75_0_g11761.y - 0.2 ) , 0.0 ) );
				float temp_output_47_0_g11761 = max( _FlameRadius , 0.01 );
				float clampResult70_g11761 = clamp( ( ( ( localMyCustomExpression16_g11762 * pow( saferPower57_g11761 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g11761 - distance( temp_output_75_0_g11761 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g11761 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				float temp_output_63_0_g11761 = ( clampResult70_g11761 * _FlameBrightness );
				float4 appendResult31_g11761 = (float4(temp_output_63_0_g11761 , temp_output_63_0_g11761 , temp_output_63_0_g11761 , clampResult70_g11761));
				float4 staticSwitch6_g11759 = ( appendResult31_g11761 * staticSwitch2_g11759 );
				#else
				float4 staticSwitch6_g11759 = staticSwitch2_g11759;
				#endif
				float4 temp_output_3_0_g11763 = staticSwitch6_g11759;
				float4 temp_output_1_0_g11795 = temp_output_3_0_g11763;
				float4 appendResult91_g11795 = (float4((temp_output_1_0_g11795).rgb , 1.0));
				float2 temp_output_1_0_g11763 = finalUV146;
				#ifdef _ENABLERECOLORRGB_ON
				#ifdef _RECOLORRGBTEXTURETOGGLE_ON
				float4 staticSwitch81_g11795 = tex2D( _RecolorRGBTexture, temp_output_1_0_g11763 );
				#else
				float4 staticSwitch81_g11795 = appendResult91_g11795;
				#endif
				float3 break82_g11795 = (staticSwitch81_g11795).xyz;
				float temp_output_84_0_g11795 = max( ( break82_g11795.x + break82_g11795.y + break82_g11795.z ) , 0.001 );
				float4 break71_g11795 = ( ( _RecolorRGBRedTint * ( break82_g11795.x / temp_output_84_0_g11795 ) ) + ( _RecolorRGBGreenTint * ( break82_g11795.y / temp_output_84_0_g11795 ) ) + ( ( break82_g11795.z / temp_output_84_0_g11795 ) * _RecolorRGBBlueTint ) );
				float3 appendResult56_g11795 = (float3(break71_g11795.r , break71_g11795.g , break71_g11795.b));
				float4 break2_g11796 = temp_output_1_0_g11795;
				float saferPower57_g11795 = abs( ( ( break2_g11796.x + break2_g11796.x + break2_g11796.y + break2_g11796.y + break2_g11796.y + break2_g11796.z ) / 6.0 ) );
				float3 lerpResult26_g11795 = lerp( (temp_output_1_0_g11795).rgb , ( appendResult56_g11795 * pow( saferPower57_g11795 , ( max( break71_g11795.a , 0.01 ) * 2.0 ) ) ) , ( staticSwitch81_g11795.w * _RecolorRGBFade ));
				float4 appendResult30_g11795 = (float4(lerpResult26_g11795 , temp_output_1_0_g11795.a));
				float4 staticSwitch43_g11763 = appendResult30_g11795;
				#else
				float4 staticSwitch43_g11763 = temp_output_3_0_g11763;
				#endif
				#ifdef _ENABLERECOLORRGBYCP_ON
				float4 temp_output_1_0_g11793 = staticSwitch43_g11763;
				#ifdef _RECOLORRGBYCPTEXTURETOGGLE_ON
				float4 staticSwitch62_g11793 = tex2D( _RecolorRGBYCPTexture, temp_output_1_0_g11763 );
				#else
				float4 staticSwitch62_g11793 = temp_output_1_0_g11793;
				#endif
				float3 hsvTorgb33_g11793 = RGBToHSV( staticSwitch62_g11793.rgb );
				float temp_output_43_0_g11793 = ( ( hsvTorgb33_g11793.x + 0.08333334 ) % 1.0 );
				float4 ifLocalVar46_g11793 = 0;
				if( temp_output_43_0_g11793 >= 0.8333333 )
				ifLocalVar46_g11793 = _RecolorRGBYCPPurpleTint;
				else
				ifLocalVar46_g11793 = _RecolorRGBYCPBlueTint;
				float4 ifLocalVar44_g11793 = 0;
				if( temp_output_43_0_g11793 <= 0.6666667 )
				ifLocalVar44_g11793 = _RecolorRGBYCPCyanTint;
				else
				ifLocalVar44_g11793 = ifLocalVar46_g11793;
				float4 ifLocalVar47_g11793 = 0;
				if( temp_output_43_0_g11793 <= 0.3333333 )
				ifLocalVar47_g11793 = _RecolorRGBYCPYellowTint;
				else
				ifLocalVar47_g11793 = _RecolorRGBYCPGreenTint;
				float4 ifLocalVar45_g11793 = 0;
				if( temp_output_43_0_g11793 <= 0.1666667 )
				ifLocalVar45_g11793 = _RecolorRGBYCPRedTint;
				else
				ifLocalVar45_g11793 = ifLocalVar47_g11793;
				float4 ifLocalVar35_g11793 = 0;
				if( temp_output_43_0_g11793 >= 0.5 )
				ifLocalVar35_g11793 = ifLocalVar44_g11793;
				else
				ifLocalVar35_g11793 = ifLocalVar45_g11793;
				float4 break55_g11793 = ifLocalVar35_g11793;
				float3 appendResult56_g11793 = (float3(break55_g11793.r , break55_g11793.g , break55_g11793.b));
				float4 break2_g11794 = temp_output_1_0_g11793;
				float saferPower57_g11793 = abs( ( ( break2_g11794.x + break2_g11794.x + break2_g11794.y + break2_g11794.y + break2_g11794.y + break2_g11794.z ) / 6.0 ) );
				float3 lerpResult26_g11793 = lerp( (temp_output_1_0_g11793).rgb , ( appendResult56_g11793 * pow( saferPower57_g11793 , max( ( break55_g11793.a * 2.0 ) , 0.01 ) ) ) , ( hsvTorgb33_g11793.z * _RecolorRGBYCPFade ));
				float4 appendResult30_g11793 = (float4(lerpResult26_g11793 , temp_output_1_0_g11793.a));
				float4 staticSwitch9_g11763 = appendResult30_g11793;
				#else
				float4 staticSwitch9_g11763 = staticSwitch43_g11763;
				#endif
				#ifdef _ENABLECOLORREPLACE_ON
				float4 temp_output_1_0_g11767 = staticSwitch9_g11763;
				float3 temp_output_2_0_g11767 = (temp_output_1_0_g11767).rgb;
				float3 In115_g11767 = temp_output_2_0_g11767;
				float3 From115_g11767 = (_ColorReplaceFromColor).rgb;
				float4 break2_g11768 = temp_output_1_0_g11767;
				float3 To115_g11767 = ( pow( max( ( ( break2_g11768.x + break2_g11768.x + break2_g11768.y + break2_g11768.y + break2_g11768.y + break2_g11768.z ) / 6.0 ) , 0.0001 ) , max( _ColorReplaceContrast , 0.0001 ) ) * (_ColorReplaceToColor).rgb );
				float Fuzziness115_g11767 = _ColorReplaceSmoothness;
				float Range115_g11767 = _ColorReplaceRange;
				float3 localMyCustomExpression115_g11767 = MyCustomExpression115_g11767( In115_g11767 , From115_g11767 , To115_g11767 , Fuzziness115_g11767 , Range115_g11767 );
				float3 lerpResult112_g11767 = lerp( temp_output_2_0_g11767 , localMyCustomExpression115_g11767 , _ColorReplaceFade);
				float4 appendResult4_g11767 = (float4(lerpResult112_g11767 , temp_output_1_0_g11767.a));
				float4 staticSwitch29_g11763 = appendResult4_g11767;
				#else
				float4 staticSwitch29_g11763 = staticSwitch9_g11763;
				#endif
				float4 temp_output_1_0_g11780 = staticSwitch29_g11763;
				#ifdef _ENABLENEGATIVE_ON
				float3 temp_output_9_0_g11780 = (temp_output_1_0_g11780).rgb;
				float3 lerpResult3_g11780 = lerp( temp_output_9_0_g11780 , ( 1.0 - temp_output_9_0_g11780 ) , _NegativeFade);
				float4 appendResult8_g11780 = (float4(lerpResult3_g11780 , temp_output_1_0_g11780.a));
				float4 staticSwitch4_g11780 = appendResult8_g11780;
				#else
				float4 staticSwitch4_g11780 = temp_output_1_0_g11780;
				#endif
				float4 temp_output_57_0_g11763 = staticSwitch4_g11780;
				#ifdef _ENABLECONTRAST_ON
				float4 temp_output_1_0_g11803 = temp_output_57_0_g11763;
				float3 temp_cast_30 = (max( _Contrast , 0.0001 )).xxx;
				float4 appendResult4_g11803 = (float4(pow( max( (temp_output_1_0_g11803).rgb , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_30 ) , temp_output_1_0_g11803.a));
				float4 staticSwitch32_g11763 = appendResult4_g11803;
				#else
				float4 staticSwitch32_g11763 = temp_output_57_0_g11763;
				#endif
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 temp_output_2_0_g11778 = staticSwitch32_g11763;
				float4 appendResult6_g11778 = (float4(( (temp_output_2_0_g11778).rgb * _Brightness ) , temp_output_2_0_g11778.a));
				float4 staticSwitch33_g11763 = appendResult6_g11778;
				#else
				float4 staticSwitch33_g11763 = staticSwitch32_g11763;
				#endif
				#ifdef _ENABLEHUE_ON
				float4 temp_output_2_0_g11779 = staticSwitch33_g11763;
				float3 hsvTorgb1_g11779 = RGBToHSV( temp_output_2_0_g11779.rgb );
				float3 hsvTorgb3_g11779 = HSVToRGB( float3(( hsvTorgb1_g11779.x + _Hue ),hsvTorgb1_g11779.y,hsvTorgb1_g11779.z) );
				float4 appendResult8_g11779 = (float4(hsvTorgb3_g11779 , temp_output_2_0_g11779.a));
				float4 staticSwitch36_g11763 = appendResult8_g11779;
				#else
				float4 staticSwitch36_g11763 = staticSwitch33_g11763;
				#endif
				#ifdef _ENABLESPLITTONING_ON
				float4 temp_output_1_0_g11797 = staticSwitch36_g11763;
				float4 break2_g11798 = temp_output_1_0_g11797;
				float temp_output_3_0_g11797 = ( ( break2_g11798.x + break2_g11798.x + break2_g11798.y + break2_g11798.y + break2_g11798.y + break2_g11798.z ) / 6.0 );
				float clampResult25_g11797 = clamp( ( ( ( ( temp_output_3_0_g11797 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g11797 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g11797);
				float3 lerpResult11_g11797 = lerp( (temp_output_1_0_g11797).rgb , ( lerpResult6_g11797 * pow( max( temp_output_3_0_g11797 , 0.0001 ) , max( _SplitToningContrast , 0.0001 ) ) ) , _SplitToningFade);
				float4 appendResult18_g11797 = (float4(lerpResult11_g11797 , temp_output_1_0_g11797.a));
				float4 staticSwitch30_g11763 = appendResult18_g11797;
				#else
				float4 staticSwitch30_g11763 = staticSwitch36_g11763;
				#endif
				#ifdef _ENABLEBLACKTINT_ON
				float4 temp_output_1_0_g11775 = staticSwitch30_g11763;
				float3 temp_output_4_0_g11775 = (temp_output_1_0_g11775).rgb;
				float4 break12_g11775 = temp_output_1_0_g11775;
				float3 lerpResult7_g11775 = lerp( temp_output_4_0_g11775 , ( temp_output_4_0_g11775 + (_BlackTintColor).rgb ) , pow( max( ( 1.0 - min( max( max( break12_g11775.r , break12_g11775.g ) , break12_g11775.b ) , 1.0 ) ) , 0.0001 ) , max( _BlackTintPower , 0.0001 ) ));
				...
				float4 staticSwitch20_g11763 = appendResult11_g11775;
				#else
				float4 staticSwitch20_g11763 = staticSwitch30_g11763;
				#endif
				#ifdef _ENABLEINKSPREAD_ON
				float4 temp_output_1_0_g11789 = staticSwitch20_g11763;
				float4 break2_g11791 = temp_output_1_0_g11789;
				float2 temp_output_65_0_g11789 = shaderPosition235;
				float linValue16_g11790 = tex2D( _UberNoiseTexture, ( temp_output_65_0_g11789 * _InkSpreadNoiseScale ) ).r;
				float localMyCustomExpression16_g11790 = MyCustomExpression16_g11790( linValue16_g11790 );
				float clampResult53_g11789 = clamp( ( ( ( _InkSpreadDistance - distance( _InkSpreadPosition , temp_output_65_0_g11789 ) ) + ( localMyCustomExpression16_g11790 * _InkSpreadNoiseFactor ) ) / max( _InkSpreadWidth , 0.001 ) ) , 0.0 , 1.0 );
				float3 lerpResult7_g11789 = lerp( (temp_output_1_0_g11789).rgb , ( (_InkSpreadColor).rgb * pow( max( ( ( break2_g11791.x + break2_g11791.x + break2_g11791.y + break2_g11791.y + break2_g11791.y + break2_g11791.z ) / 6.0 ) , 0.0001 ) , max( _InkSpreadContrast , 0.0001 ) ) ) , ( _InkSpreadFade * clampResult53_g11789 ));
				float4 appendResult9_g11789 = (float4(lerpResult7_g11789 , (temp_output_1_0_g11789).a));
				float4 staticSwitch17_g11763 = appendResult9_g11789;
				#else
				float4 staticSwitch17_g11763 = staticSwitch20_g11763;
				#endif
				float temp_output_39_0_g11763 = shaderTime237;
				#ifdef _ENABLESHIFTHUE_ON
				float4 temp_output_1_0_g11781 = staticSwitch17_g11763;
				float3 hsvTorgb15_g11781 = RGBToHSV( (temp_output_1_0_g11781).rgb );
				float3 hsvTorgb19_g11781 = HSVToRGB( float3(( ( temp_output_39_0_g11763 * _ShiftHueSpeed ) + hsvTorgb15_g11781.x ),hsvTorgb15_g11781.y,hsvTorgb15_g11781.z) );
				float4 appendResult6_g11781 = (float4(hsvTorgb19_g11781 , temp_output_1_0_g11781.a));
				float4 staticSwitch19_g11763 = appendResult6_g11781;
				#else
				float4 staticSwitch19_g11763 = staticSwitch17_g11763;
				#endif
				#ifdef _ENABLEADDHUE_ON
				float3 hsvTorgb19_g11785 = HSVToRGB( float3(( ( temp_output_39_0_g11763 * _AddHueSpeed ) % 1.0 ),_AddHueSaturation,_AddHueBrightness) );
				float4 temp_output_1_0_g11785 = staticSwitch19_g11763;
				float4 break2_g11787 = temp_output_1_0_g11785;
				float2 uv_AddHueMask = IN.texcoord.xy * _AddHueMask_ST.xy + _AddHueMask_ST.zw;
				float4 tex2DNode3_g11786 = tex2D( _AddHueMask, uv_AddHueMask );
				#ifdef _ADDHUEMASKTOGGLE_ON
				float staticSwitch33_g11785 = ( _AddHueFade * ( tex2DNode3_g11786.r * tex2DNode3_g11786.a ) );
				#else
				float staticSwitch33_g11785 = _AddHueFade;
				#endif
				float4 appendResult6_g11785 = (float4(( ( hsvTorgb19_g11785 * pow( max( ( ( break2_g11787.x + break2_g11787.x + break2_g11787.y + break2_g11787.y + break2_g11787.y + break2_g11787.z ) / 6.0 ) , 0.0001 ) , max( _AddHueContrast , 0.0001 ) ) * staticSwitch33_g11785 ) + (temp_output_1_0_g11785).rgb ) , temp_output_1_0_g11785.a));
				float4 staticSwitch23_g11763 = appendResult6_g11785;
				#else
				float4 staticSwitch23_g11763 = staticSwitch19_g11763;
				#endif
				#ifdef _ENABLESINEGLOW_ON
				float4 temp_output_1_0_g11782 = staticSwitch23_g11763;
				float4 break2_g11783 = temp_output_1_0_g11782;
				float3 temp_output_13_0_g11782 = (_SineGlowColor).rgb;
				float2 uv_SineGlowMask = IN.texcoord.xy * _SineGlowMask_ST.xy + _SineGlowMask_ST.zw;
				float4 tex2DNode30_g11782 = tex2D( _SineGlowMask, uv_SineGlowMask );
				#ifdef _SINEGLOWMASKTOGGLE_ON
				float3 staticSwitch27_g11782 = ( (tex2DNode30_g11782).rgb * temp_output_13_0_g11782 * tex2DNode30_g11782.a );
				#else
				float3 staticSwitch27_g11782 = temp_output_13_0_g11782;
				#endif
				float4 appendResult21_g11782 = (float4(( (temp_output_1_0_g11782).rgb + ( pow( max( ( ( break2_g11783.x + break2_g11783.x + break2_g11783.y + break2_g11783.y + break2_g11783.y + break2_g11783.z ) / 6.0 ) , 0.0001 ) , max( _SineGlowContrast , 0.0001 ) ) * staticSwitch27_g11782 * _SineGlowFade * ( ( ( sin( ( temp_output_39_0_g11763 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g11782.a));
				float4 staticSwitch28_g11763 = appendResult21_g11782;
				#else
				float4 staticSwitch28_g11763 = staticSwitch23_g11763;
				#endif
				#ifdef _ENABLESATURATION_ON
				float4 temp_output_1_0_g11770 = staticSwitch28_g11763;
				float4 break2_g11771 = temp_output_1_0_g11770;
				float3 temp_cast_46 = (( ( break2_g11771.x + break2_g11771.x + break2_g11771.y + break2_g11771.y + break2_g11771.y + break2_g11771.z ) / 6.0 )).xxx;
				float3 lerpResult5_g11770 = lerp( temp_cast_46 , (temp_output_1_0_g11770).rgb , _Saturation);
				float4 appendResult8_g11770 = (float4(lerpResult5_g11770 , temp_output_1_0_g11770.a));
				float4 staticSwitch38_g11763 = appendResult8_g11770;
				#else
				float4 staticSwitch38_g11763 = staticSwitch28_g11763;
				#endif
				#ifdef _ENABLEINNEROUTLINE_ON
				float4 temp_output_15_0_g11772 = staticSwitch38_g11763;
				float3 temp_output_82_0_g11772 = (_InnerOutlineColor).rgb;
				float2 temp_output_7_0_g11772 = temp_output_1_0_g11763;
				float temp_output_179_0_g11772 = temp_output_39_0_g11763;
				...
				float4 staticSwitch12_g11763 = appendResult177_g11772;
				#else
				float4 staticSwitch12_g11763 = staticSwitch38_g11763;
				#endif
				#ifdef _ENABLEOUTEROUTLINE_ON
				float4 temp_output_15_0_g11800 = staticSwitch12_g11763;
				float3 temp_output_82_0_g11800 = (_OuterOutlineColor).rgb;
				float2 temp_output_7_0_g11800 = temp_output_1_0_g11763;
				float temp_output_186_0_g11800 = temp_output_39_0_g11763;
				#ifdef _OUTEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11800 = ( (tex2D( _OuterOutlineTintTexture, ( temp_output_7_0_g11800 + ( _OuterOutlineTextureSpeed * temp_output_186_0_g11800 ) ) )).rgb * temp_output_82_0_g11800 );
				#else
				float3 staticSwitch199_g11800 = temp_output_82_0_g11800;
				#endif
				float temp_output_182_0_g11800 = ( ( 1.0 - temp_output_15_0_g11800.a ) * min( ( _OuterOutlineFade * 3.0 ) , 1.0 ) );
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11800 = 1.0;
				#else
				float staticSwitch203_g11800 = temp_output_182_0_g11800;
				#endif
				float3 lerpResult178_g11800 = lerp( (temp_output_15_0_g11800).rgb , staticSwitch199_g11800 , staticSwitch203_g11800);
				float3 lerpResult170_g11800 = lerp( lerpResult178_g11800 , staticSwitch199_g11800 , staticSwitch203_g11800);
				float linValue16_g11801 = tex2D( _UberNoiseTexture, ( ( ( temp_output_186_0_g11800 * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g11800 ) * _OuterOutlineNoiseScale ) ).r;
				...
				float2 staticSwitch157_g11800 = ( ( localMyCustomExpression16_g11801 - 0.5 ) * _OuterOutlineDistortionIntensity );
				#else
				...
				#else
				float staticSwitch200_g11800 = lerpResult168_g11800;
				#endif
				float4 appendResult174_g11800 = (float4(lerpResult170_g11800 , staticSwitch200_g11800));
				float4 staticSwitch13_g11763 = appendResult174_g11800;
				#else
				float4 staticSwitch13_g11763 = staticSwitch12_g11763;
				#endif
				#ifdef _ENABLEPIXELOUTLINE_ON
				float4 temp_output_15_0_g11777 = staticSwitch13_g11763;
				float3 temp_output_82_0_g11777 = (_PixelOutlineColor).rgb;
				float2 temp_output_7_0_g11777 = temp_output_1_0_g11763;
				#ifdef _PIXELOUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11777 = ( (tex2D( _PixelOutlineTintTexture, ( temp_output_7_0_g11777 + ( _PixelOutlineTextureSpeed * temp_output_39_0_g11763 ) ) )).rgb * temp_output_82_0_g11777 );
				#else
				float3 staticSwitch199_g11777 = temp_output_82_0_g11777;
				#endif
				float temp_output_213_0_g11777 = ( _PixelOutlineFade * step( temp_output_15_0_g11777.a , _PixelOutlineAlphaLimit ) );
				float temp_output_182_0_g11777 = ( ( 1.0 - temp_output_15_0_g11777.a ) * min( ( temp_output_213_0_g11777 * 3.0 ) , 1.0 ) );
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11777 = 1.0;
				#else
				float staticSwitch203_g11777 = temp_output_182_0_g11777;
				#endif
				float3 lerpResult178_g11777 = lerp( (temp_output_15_0_g11777).rgb , staticSwitch199_g11777 , staticSwitch203_g11777);
				float3 lerpResult170_g11777 = lerp( lerpResult178_g11777 , staticSwitch199_g11777 , staticSwitch203_g11777);
				float2 appendResult206_g11777 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_209_0_g11777 = ( float2( 1,1 ) / appendResult206_g11777 );
				float lerpResult168_g11777 = lerp( temp_output_15_0_g11777.a , min( ( max( max( max( tex2D( _MainTex, ( temp_output_7_0_g11777 + ( ( _PixelOutlineWidth * float2( 0,-1 ) ) * temp_output_209_0_g11777 ) ) ).a , tex2D( _MainTex, ( temp_output_7_0_g11777 + ( ( _PixelOutlineWidth * float2( 0,1 ) ) * temp_output_209_0_g11777 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11777 + ( ( _PixelOutlineWidth * float2( -1,0 ) ) * temp_output_209_0_g11777 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11777 + ( ( _PixelOutlineWidth * float2( 1,0 ) ) * temp_output_209_0_g11777 ) ) ).a ) * 3.0 ) , 1.0 ) , temp_output_213_0_g11777);
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11777 = ( temp_output_182_0_g11777 * lerpResult168_g11777 );
				#else
				float staticSwitch200_g11777 = lerpResult168_g11777;
				#endif
				float4 appendResult174_g11777 = (float4(lerpResult170_g11777 , staticSwitch200_g11777));
				float4 staticSwitch48_g11763 = appendResult174_g11777;
				#else
				float4 staticSwitch48_g11763 = staticSwitch13_g11763;
				#endif
				#ifdef _ENABLEPINGPONGGLOW_ON
				float3 lerpResult15_g11764 = lerp( (_PingPongGlowFrom).rgb , (_PingPongGlowTo).rgb , ( ( sin( ( temp_output_39_0_g11763 * _PingPongGlowFrequency ) ) + 1.0 ) / 2.0 ));
				float4 temp_output_5_0_g11764 = staticSwitch48_g11763;
				float4 break2_g11765 = temp_output_5_0_g11764;
				float4 appendResult12_g11764 = (float4(( ( lerpResult15_g11764 * _PingPongGlowFade * pow( max( ( ( break2_g11765.x + break2_g11765.x + break2_g11765.y + break2_g11765.y + break2_g11765.y + break2_g11765.z ) / 6.0 ) , 0.0001 ) , max( _PingPongGlowContrast , 0.0001 ) ) ) + (temp_output_5_0_g11764).rgb ) , temp_output_5_0_g11764.a));
				float4 staticSwitch46_g11763 = appendResult12_g11764;
				#else
				float4 staticSwitch46_g11763 = staticSwitch48_g11763;
				#endif
				float4 temp_output_361_0 = staticSwitch46_g11763;
				#ifdef _ENABLEHOLOGRAM_ON
				float4 temp_output_1_0_g11805 = temp_output_361_0;
				float4 break2_g11806 = temp_output_1_0_g11805;
				float4 appendResult22_g11805 = (float4(( (_HologramTint).rgb * pow( max( ( ( break2_g11806.x + break2_g11806.x + break2_g11806.y + break2_g11806.y + break2_g11806.y + break2_g11806.z ) / 6.0 ) , 0.0001 ) , max( _HologramContrast , 0.0001 ) ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g11805.a )));
				float4 lerpResult37_g11805 = lerp( temp_output_1_0_g11805 , appendResult22_g11805 , hologramFade182);
				float4 staticSwitch56 = lerpResult37_g11805;
				#else
				float4 staticSwitch56 = temp_output_361_0;
				#endif
				#ifdef _ENABLEGLITCH_ON
				float4 temp_output_1_0_g11808 = staticSwitch56;
				float4 break2_g11810 = temp_output_1_0_g11808;
				float temp_output_34_0_g11808 = shaderTime237;
				float linValue16_g11809 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchNoiseSpeed * temp_output_34_0_g11808 ) ) * _GlitchNoiseScale ) ).r;
				float localMyCustomExpression16_g11809 = MyCustomExpression16_g11809( linValue16_g11809 );
				float3 hsvTorgb3_g11811 = HSVToRGB( float3(( localMyCustomExpression16_g11809 + ( temp_output_34_0_g11808 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g11808 = lerp( (temp_output_1_0_g11808).rgb , ( ( ( break2_g11810.x + break2_g11810.x + break2_g11810.y + break2_g11810.y + break2_g11810.y + break2_g11810.z ) / 6.0 ) * _GlitchBrightness * hsvTorgb3_g11811 ) , glitchFade152);
				float4 appendResult27_g11808 = (float4(lerpResult23_g11808 , temp_output_1_0_g11808.a));
				float4 staticSwitch57 = appendResult27_g11808;
				#else
				float4 staticSwitch57 = staticSwitch56;
				#endif
				float4 temp_output_3_0_g11812 = staticSwitch57;
				float4 temp_output_1_0_g11842 = temp_output_3_0_g11812;
				float2 temp_output_41_0_g11812 = shaderPosition235;
				float2 temp_output_99_0_g11842 = temp_output_41_0_g11812;
				float temp_output_40_0_g11812 = shaderTime237;
				#ifdef _ENABLECAMOUFLAGE_ON
				float linValue16_g11847 = tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g11812 * _CamouflageDistortionSpeed ) + temp_output_99_0_g11842 ) * _CamouflageDistortionScale ) ).r;
				float localMyCustomExpression16_g11847 = MyCustomExpression16_g11847( linValue16_g11847 );
				#ifdef _CAMOUFLAGEANIMATIONTOGGLE_ON
				float2 staticSwitch101_g11842 = ( ( ( localMyCustomExpression16_g11847 - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g11842 );
				#else
				float2 staticSwitch101_g11842 = temp_output_99_0_g11842;
				#endif
				float linValue16_g11844 = tex2D( _UberNoiseTexture, ( staticSwitch101_g11842 * _CamouflageNoiseScaleA ) ).r;
				float localMyCustomExpression16_g11844 = MyCustomExpression16_g11844( linValue16_g11844 );
				float clampResult52_g11842 = clamp( ( ( _CamouflageDensityA - localMyCustomExpression16_g11844 ) / max( _CamouflageSmoothnessA , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult55_g11842 = lerp( _CamouflageBaseColor , ( _CamouflageColorA * clampResult52_g11842 ) , clampResult52_g11842);
				float linValue16_g11846 = tex2D( _UberNoiseTexture, ( ( staticSwitch101_g11842 + float2( 12.3,12.3 ) ) * _CamouflageNoiseScaleB ) ).r;
				float localMyCustomExpression16_g11846 = MyCustomExpression16_g11846( linValue16_g11846 );
				float clampResult65_g11842 = clamp( ( ( _CamouflageDensityB - localMyCustomExpression16_g11846 ) / max( _CamouflageSmoothnessB , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult68_g11842 = lerp( lerpResult55_g11842 , ( _CamouflageColorB * clampResult65_g11842 ) , clampResult65_g11842);
				float4 break2_g11845 = temp_output_1_0_g11842;
				float3 lerpResult4_g11842 = lerp( (temp_output_1_0_g11842).rgb , ( (lerpResult68_g11842).rgb * pow( max( ( ( break2_g11845.x + break2_g11845.x + break2_g11845.y + break2_g11845.y + break2_g11845.y + break2_g11845.z ) / 6.0 ) , 0.0001 ) , max( _CamouflageContrast , 0.0001 ) ) ) , _CamouflageFade);
				float4 appendResult7_g11842 = (float4(lerpResult4_g11842 , temp_output_1_0_g11842.a));
				float4 staticSwitch26_g11812 = appendResult7_g11842;
				#else
				float4 staticSwitch26_g11812 = temp_output_3_0_g11812;
				#endif
				#ifdef _ENABLEMETAL_ON
				float4 temp_output_1_0_g11835 = staticSwitch26_g11812;
				float temp_output_59_0_g11835 = temp_output_40_0_g11812;
				float2 temp_output_58_0_g11835 = temp_output_41_0_g11812;
				float linValue16_g11836 = tex2D( _UberNoiseTexture, ( ( ( temp_output_59_0_g11835 * _MetalNoiseDistortionSpeed ) + temp_output_58_0_g11835 ) * _MetalNoiseDistortionScale ) ).r;
				float localMyCustomExpression16_g11836 = MyCustomExpression16_g11836( linValue16_g11836 );
				float linValue16_g11838 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11836 - 0.25 ) * _MetalNoiseDistortion ) + ( ( temp_output_59_0_g11835 * _MetalNoiseSpeed ) + temp_output_58_0_g11835 ) ) * _MetalNoiseScale ) ).r;
				...
				float temp_output_5_0_g11835 = ( ( break2_g11837.x + break2_g11837.x + break2_g11837.y + break2_g11837.y + break2_g11837.y + break2_g11837.z ) / 6.0 );
				float2 uv_MetalMask = IN.texcoord.xy * _MetalMask_ST.xy + _MetalMask_ST.zw;
				float4 tex2DNode3_g11840 = tex2D( _MetalMask, uv_MetalMask );
				#ifdef _METALMASKTOGGLE_ON
				float staticSwitch60_g11835 = ( _MetalFade * ( tex2DNode3_g11840.r * tex2DNode3_g11840.a ) );
				#else
				float staticSwitch60_g11835 = _MetalFade;
				#endif
				float4 lerpResult45_g11835 = lerp( temp_output_1_0_g11835 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g11838 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( max( temp_output_5_0_g11835 , 0.0001 ) , max( _MetalHighlightContrast , 0.0001 ) ) ) + ( pow( max( temp_output_5_0_g11835 , 0.0001 ) , max( _MetalContrast , 0.0001 ) ) * _MetalColor ) ) , staticSwitch60_g11835);
				float4 appendResult8_g11835 = (float4((lerpResult45_g11835).rgb , (temp_output_1_0_g11835).a));
				float4 staticSwitch28_g11812 = appendResult8_g11835;
				#else
				float4 staticSwitch28_g11812 = staticSwitch26_g11812;
				#endif
				#ifdef _ENABLEFROZEN_ON
				float4 temp_output_1_0_g11827 = staticSwitch28_g11812;
				float4 break2_g11828 = temp_output_1_0_g11827;
				float temp_output_7_0_g11827 = ( ( break2_g11828.x + break2_g11828.x + break2_g11828.y + break2_g11828.y + break2_g11828.y + break2_g11828.z ) / 6.0 );
				float2 temp_output_72_0_g11827 = temp_output_41_0_g11812;
				float linValue16_g11829 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11827 * _FrozenSnowScale ) ).r;
				float localMyCustomExpression16_g11829 = MyCustomExpression16_g11829( linValue16_g11829 );
				float temp_output_73_0_g11827 = temp_output_40_0_g11812;
				float linValue16_g11831 = tex2D( _UberNoiseTexture, ( ( ( temp_output_73_0_g11827 * _FrozenHighlightDistortionSpeed ) + temp_output_72_0_g11827 ) * _FrozenHighlightDistortionScale ) ).r;
				float localMyCustomExpression16_g11831 = MyCustomExpression16_g11831( linValue16_g11831 );
				float linValue16_g11832 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11831 - 0.25 ) * _FrozenHighlightDistortion ) + ( ( temp_output_73_0_g11827 * _FrozenHighlightSpeed ) + temp_output_72_0_g11827 ) ) * _FrozenHighlightScale ) ).r;
				float localMyCustomExpression16_g11832 = MyCustomExpression16_g11832( linValue16_g11832 );
				float3 lerpResult57_g11827 = lerp( (temp_output_1_0_g11827).rgb , ( ( pow( max( temp_output_7_0_g11827 , 0.0001 ) , max( _FrozenContrast , 0.0001 ) ) * (_FrozenTint).rgb ) + ( pow( max( temp_output_7_0_g11827 , 0.0001 ) , max( _FrozenSnowContrast , 0.0001 ) ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g11829 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g11832 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( max( temp_output_7_0_g11827 , 0.0001 ) , max( _FrozenHighlightContrast , 0.0001 ) ) )).rgb ) , _FrozenFade);
				float4 appendResult26_g11827 = (float4(lerpResult57_g11827 , temp_output_1_0_g11827.a));
				float4 staticSwitch29_g11812 = appendResult26_g11827;
				#else
				float4 staticSwitch29_g11812 = staticSwitch28_g11812;
				#endif
				#ifdef _ENABLEBURN_ON
				float4 temp_output_1_0_g11821 = staticSwitch29_g11812;
				float3 temp_output_28_0_g11821 = (temp_output_1_0_g11821).rgb;
				float4 break2_g11825 = float4( temp_output_28_0_g11821 , 0.0 );
				float2 temp_output_72_0_g11821 = temp_output_41_0_g11812;
				float linValue16_g11824 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11821 * _BurnSwirlNoiseScale ) ).r;
				float localMyCustomExpression16_g11824 = MyCustomExpression16_g11824( linValue16_g11824 );
				float linValue16_g11822 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11824 - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_72_0_g11821 ) * _BurnInsideNoiseScale ) ).r;
				float localMyCustomExpression16_g11822 = MyCustomExpression16_g11822( linValue16_g11822 );
				float clampResult68_g11821 = clamp( ( _BurnInsideNoiseFactor - localMyCustomExpression16_g11822 ) , 0.0 , 1.0 );
				float linValue16_g11823 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11821 * _BurnEdgeNoiseScale ) ).r;
				float localMyCustomExpression16_g11823 = MyCustomExpression16_g11823( linValue16_g11823 );
				float temp_output_15_0_g11821 = ( ( ( _BurnRadius - distance( temp_output_72_0_g11821 , _BurnPosition ) ) + ( localMyCustomExpression16_g11823 * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g11821 = clamp( temp_output_15_0_g11821 , 0.0 , 1.0 );
				float3 lerpResult29_g11821 = lerp( temp_output_28_0_g11821 , ( pow( max( ( ( break2_g11825.x + break2_g11825.x + break2_g11825.y + break2_g11825.y + break2_g11825.y + break2_g11825.z ) / 6.0 ) , 0.0001 ) , max( _BurnInsideContrast , 0.0001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g11821 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g11821);
				float3 lerpResult40_g11821 = lerp( temp_output_28_0_g11821 , ( lerpResult29_g11821 + ( ( step( temp_output_15_0_g11821 , 1.0 ) * step( 0.0 , temp_output_15_0_g11821 ) ) * (_BurnEdgeColor).rgb ) ) , _BurnFade);
				float4 appendResult43_g11821 = (float4(lerpResult40_g11821 , temp_output_1_0_g11821.a));
				float4 staticSwitch32_g11812 = appendResult43_g11821;
				#else
				float4 staticSwitch32_g11812 = staticSwitch29_g11812;
				#endif
				#ifdef _ENABLERAINBOW_ON
				float2 temp_output_42_0_g11817 = temp_output_41_0_g11812;
				float linValue16_g11818 = tex2D( _UberNoiseTexture, ( temp_output_42_0_g11817 * _RainbowNoiseScale ) ).r;
				float localMyCustomExpression16_g11818 = MyCustomExpression16_g11818( linValue16_g11818 );
				float3 hsvTorgb3_g11820 = HSVToRGB( float3(( ( ( distance( temp_output_42_0_g11817 , _RainbowCenter ) + ( localMyCustomExpression16_g11818 * _RainbowNoiseFactor ) ) * _RainbowDensity ) + ( _RainbowSpeed * temp_output_40_0_g11812 ) ),1.0,1.0) );
				float3 hsvTorgb36_g11817 = RGBToHSV( hsvTorgb3_g11820 );
				float3 hsvTorgb37_g11817 = HSVToRGB( float3(hsvTorgb36_g11817.x,_RainbowSaturation,( hsvTorgb36_g11817.z * _RainbowBrightness )) );
				float4 temp_output_1_0_g11817 = staticSwitch32_g11812;
				float4 break2_g11819 = temp_output_1_0_g11817;
				float saferPower24_g11817 = abs( ( ( break2_g11819.x + break2_g11819.x + break2_g11819.y + break2_g11819.y + break2_g11819.y + break2_g11819.z ) / 6.0 ) );
				float4 appendResult29_g11817 = (float4(( ( hsvTorgb37_g11817 * pow( saferPower24_g11817 , max( _RainbowContrast , 0.001 ) ) * _RainbowFade ) + (temp_output_1_0_g11817).rgb ) , temp_output_1_0_g11817.a));
				float4 staticSwitch34_g11812 = appendResult29_g11817;
				#else
				float4 staticSwitch34_g11812 = staticSwitch32_g11812;
				#endif
				#ifdef _ENABLESHINE_ON
				float4 temp_output_1_0_g11813 = staticSwitch34_g11812;
				float3 temp_output_57_0_g11813 = (temp_output_1_0_g11813).rgb;
				float4 break2_g11815 = temp_output_1_0_g11813;
				float3 temp_cast_69 = (( ( break2_g11815.x + break2_g11815.x + break2_g11815.y + break2_g11815.y + break2_g11815.y + break2_g11815.z ) / 6.0 )).xxx;
				...
				float3 rotatedValue69_g11813 = RotateAroundAxis( float3( 0,0,0 ), float3( ( _ShineFrequency * temp_output_41_0_g11812 ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 180.0 ) * UNITY_PI ) );
				float temp_output_103_0_g11813 = ( _ShineFrequency * _ShineWidth );
				float clampResult80_g11813 = clamp( ( ( ( sin( ( rotatedValue69_g11813.x - ( temp_output_40_0_g11812 * _ShineSpeed * _ShineFrequency ) ) ) - ( 1.0 - temp_output_103_0_g11813 ) ) / temp_output_103_0_g11813 ) * _ShineSmooth ) , 0.0 , 1.0 );
				float2 uv_ShineMask = IN.texcoord.xy * _ShineMask_ST.xy + _ShineMask_ST.zw;
				float4 tex2DNode3_g11814 = tex2D( _ShineMask, uv_ShineMask );
				#ifdef _SHINEMASKTOGGLE_ON
				float staticSwitch98_g11813 = ( _ShineFade * ( tex2DNode3_g11814.r * tex2DNode3_g11814.a ) );
				#else
				float staticSwitch98_g11813 = _ShineFade;
				#endif
				float4 appendResult8_g11813 = (float4(( temp_output_57_0_g11813 + ( ( pow( max( lerpResult92_g11813 , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_70 ) * (_ShineColor).rgb ) * clampResult80_g11813 * staticSwitch98_g11813 ) ) , (temp_output_1_0_g11813).a));
				float4 staticSwitch36_g11812 = appendResult8_g11813;
				#else
				float4 staticSwitch36_g11812 = staticSwitch34_g11812;
				#endif
				#ifdef _ENABLEPOISON_ON
				float temp_output_41_0_g11848 = temp_output_40_0_g11812;
				float linValue16_g11850 = tex2D( _UberNoiseTexture, ( ( ( temp_output_41_0_g11848 * _PoisonNoiseSpeed ) + temp_output_41_0_g11812 ) * _PoisonNoiseScale ) ).r;
				float localMyCustomExpression16_g11850 = MyCustomExpression16_g11850( linValue16_g11850 );
				float3 temp_output_24_0_g11848 = (_PoisonColor).rgb;
				float4 temp_output_1_0_g11848 = staticSwitch36_g11812;
				float3 temp_output_28_0_g11848 = (temp_output_1_0_g11848).rgb;
				float4 break2_g11849 = float4( temp_output_28_0_g11848 , 0.0 );
				float3 lerpResult32_g11848 = lerp( temp_output_28_0_g11848 , ( temp_output_24_0_g11848 * ( ( break2_g11849.x + break2_g11849.x + break2_g11849.y + break2_g11849.y + break2_g11849.y + break2_g11849.z ) / 6.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g11848 = (float4(( ( max( pow( max( abs( ( ( ( localMyCustomExpression16_g11850 + ( temp_output_41_0_g11848 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , 0.0001 ) , max( _PoisonDensity , 0.0001 ) ) , 0.0 ) * temp_output_24_0_g11848 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g11848 ) , temp_output_1_0_g11848.a));
				float4 staticSwitch39_g11812 = appendResult27_g11848;
				#else
				float4 staticSwitch39_g11812 = staticSwitch36_g11812;
				#endif
				float4 temp_output_10_0_g11852 = staticSwitch39_g11812;
				#ifdef _ENABLEENCHANTED_ON
				float3 temp_output_12_0_g11852 = (temp_output_10_0_g11852).rgb;
				float2 temp_output_2_0_g11852 = temp_output_41_0_g11812;
				float temp_output_1_0_g11852 = temp_output_40_0_g11812;
				float2 temp_output_6_0_g11852 = ( temp_output_1_0_g11852 * _EnchantedSpeed );
				float linValue16_g11855 = tex2D( _UberNoiseTexture, ( ( ( temp_output_2_0_g11852 - ( ( temp_output_6_0_g11852 + float2( 1.234,5.6789 ) ) * float2( 0.95,1.05 ) ) ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11855 = MyCustomExpression16_g11855( linValue16_g11855 );
				float linValue16_g11853 = tex2D( _UberNoiseTexture, ( ( ( temp_output_6_0_g11852 + temp_output_2_0_g11852 ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11853 = MyCustomExpression16_g11853( linValue16_g11853 );
				float temp_output_36_0_g11852 = ( localMyCustomExpression16_g11855 + localMyCustomExpression16_g11853 );
				float temp_output_43_0_g11852 = ( temp_output_36_0_g11852 * 0.5 );
				float3 lerpResult42_g11852 = lerp( (_EnchantedLowColor).rgb , (_EnchantedHighColor).rgb , temp_output_43_0_g11852);
				float3 hsvTorgb53_g11852 = HSVToRGB( float3(( ( temp_output_43_0_g11852 * _EnchantedRainbowDensity ) + ( _EnchantedRainbowSpeed * temp_output_1_0_g11852 ) ),_EnchantedRainbowSaturation,1.0) );
				#ifdef _ENCHANTEDRAINBOWTOGGLE_ON
				float3 staticSwitch50_g11852 = hsvTorgb53_g11852;
				#else
				float3 staticSwitch50_g11852 = lerpResult42_g11852;
				#endif
				float4 break2_g11854 = temp_output_10_0_g11852;
				float3 temp_output_40_0_g11852 = ( staticSwitch50_g11852 * pow( max( ( ( break2_g11854.x + break2_g11854.x + break2_g11854.y + break2_g11854.y + break2_g11854.y + break2_g11854.z ) / 6.0 ) , 0.0001 ) , max( _EnchantedContrast , 0.0001 ) ) * _EnchantedBrightness );
				float temp_output_45_0_g11852 = ( max( ( temp_output_36_0_g11852 - _EnchantedReduce ) , 0.0 ) * _EnchantedFade );
				float3 lerpResult44_g11852 = lerp( temp_output_12_0_g11852 , temp_output_40_0_g11852 , temp_output_45_0_g11852);
				#ifdef _ENCHANTEDLERPTOGGLE_ON
				float3 staticSwitch47_g11852 = lerpResult44_g11852;
				#else
				float3 staticSwitch47_g11852 = ( temp_output_12_0_g11852 + ( temp_output_40_0_g11852 * temp_output_45_0_g11852 ) );
				#endif
				float4 appendResult19_g11852 = (float4(staticSwitch47_g11852 , temp_output_10_0_g11852.a));
				float4 staticSwitch11_g11852 = appendResult19_g11852;
				#else
				float4 staticSwitch11_g11852 = temp_output_10_0_g11852;
				#endif
				float4 temp_output_1_0_g11857 = staticSwitch11_g11852;
				#ifdef _ENABLESHIFTING_ON
				float4 break5_g11857 = temp_output_1_0_g11857;
				float3 appendResult32_g11857 = (float3(break5_g11857.r , break5_g11857.g , break5_g11857.b));
				float4 break2_g11858 = temp_output_1_0_g11857;
				float temp_output_4_0_g11857 = ( ( break2_g11858.x + break2_g11858.x + break2_g11858.y + break2_g11858.y + break2_g11858.y + break2_g11858.z ) / 6.0 );
				float temp_output_11_0_g11857 = ( ( ( temp_output_4_0_g11857 + ( temp_output_40_0_g11812 * _ShiftingSpeed ) ) * _ShiftingDensity ) % 1.0 );
				float3 lerpResult20_g11857 = lerp( (_ShiftingColorA).rgb , (_ShiftingColorB).rgb , ( abs( ( temp_output_11_0_g11857 - 0.5 ) ) * 2.0 ));
				float3 hsvTorgb12_g11857 = HSVToRGB( float3(temp_output_11_0_g11857,_ShiftingSaturation,_ShiftingBrightness) );
				#ifdef _SHIFTINGRAINBOWTOGGLE_ON
				float3 staticSwitch26_g11857 = hsvTorgb12_g11857;
				#else
				float3 staticSwitch26_g11857 = ( lerpResult20_g11857 * _ShiftingBrightness );
				#endif
				float3 lerpResult31_g11857 = lerp( appendResult32_g11857 , ( staticSwitch26_g11857 * pow( max( temp_output_4_0_g11857 , 0.0001 ) , max( _ShiftingContrast , 0.0001 ) ) ) , _ShiftingFade);
				float4 appendResult6_g11857 = (float4(lerpResult31_g11857 , break5_g11857.a));
				float4 staticSwitch33_g11857 = appendResult6_g11857;
				#else
				float4 staticSwitch33_g11857 = temp_output_1_0_g11857;
				#endif
				float4 temp_output_5_0_g11864 = staticSwitch33_g11857;
				#ifdef _ENABLETEXTURELAYER1_ON
				float4 break6_g11864 = temp_output_5_0_g11864;
				float3 appendResult11_g11864 = (float3(break6_g11864.r , break6_g11864.g , break6_g11864.b));
				float temp_output_27_0_g11864 = temp_output_40_0_g11812;
				#ifdef _TEXTURELAYER1SCROLLTOGGLE_ON
				float2 staticSwitch73_g11864 = ( _TextureLayer1Offset + ( _TextureLayer1ScrollSpeed * temp_output_27_0_g11864 ) );
				#else
				float2 staticSwitch73_g11864 = _TextureLayer1Offset;
				#endif
				float2 temp_output_72_0_g11864 = ( ( _TextureLayer1Scale * temp_output_41_0_g11812 ) - staticSwitch73_g11864 );
				float2 temp_cast_79 = (_TextureLayer1EdgeClip).xx;
				float2 UV10_g11865 = ( ( ( ( ( ( ( ( ( temp_output_72_0_g11864 % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) ) - float2( 0.5,0.5 ) ) * ( float2( 1,1 ) - temp_cast_79 ) ) + float2( 0.5,0.5 ) ) % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) );
				int Width10_g11865 = _TextureLayer1Columns;
				int Height10_g11865 = _TextureLayer1Rows;
				float Tile10_g11865 = round( ( ( _TextureLayer1Speed * temp_output_27_0_g11864 ) + _TextureLayer1StartFrame ) );
				float2 Invert10_g11865 = float2( 0,1 );
				float2 localMyCustomExpression10_g11865 = MyCustomExpression10_g11865( UV10_g11865 , Width10_g11865 , Height10_g11865 , Tile10_g11865 , Invert10_g11865 );
				#ifdef _TEXTURELAYER1SHEETTOGGLE_ON
				float2 staticSwitch20_g11864 = localMyCustomExpression10_g11865;
				#else
				float2 staticSwitch20_g11864 = temp_output_72_0_g11864;
				#endif
				float4 tex2DNode3_g11864 = tex2D( _TextureLayer1Texture, staticSwitch20_g11864 );
				float3 appendResult13_g11864 = (float3(tex2DNode3_g11864.r , tex2DNode3_g11864.g , tex2DNode3_g11864.b));
				float3 appendResult18_g11864 = (float3(_TextureLayer1Color.r , _TextureLayer1Color.g , _TextureLayer1Color.b));
				float3 temp_output_16_0_g11864 = ( appendResult13_g11864 * appendResult18_g11864 );
				float4 break2_g11866 = temp_output_5_0_g11864;
				#ifdef _TEXTURELAYER1CONTRASTTOGGLE_ON
				float3 staticSwitch80_g11864 = ( pow( max( ( ( break2_g11866.x + break2_g11866.x + break2_g11866.y + break2_g11866.y + break2_g11866.y + break2_g11866.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer1Contrast , 0.0001 ) ) * temp_output_16_0_g11864 );
				#else
				float3 staticSwitch80_g11864 = temp_output_16_0_g11864;
				#endif
				float3 lerpResult12_g11864 = lerp( appendResult11_g11864 , staticSwitch80_g11864 , ( tex2DNode3_g11864.a * _TextureLayer1Fade ));
				float4 appendResult14_g11864 = (float4(lerpResult12_g11864 , break6_g11864.a));
				float4 staticSwitch15_g11864 = appendResult14_g11864;
				#else
				float4 staticSwitch15_g11864 = temp_output_5_0_g11864;
				#endif
				float4 temp_output_5_0_g11860 = staticSwitch15_g11864;
				#ifdef _ENABLETEXTURELAYER2_ON
				...
				float temp_output_27_0_g11860 = temp_output_40_0_g11812;
				#ifdef _TEXTURELAYER2SCROLLTOGGLE_ON
				float2 staticSwitch73_g11860 = ( _TextureLayer2Offset + ( _TextureLayer2ScrollSpeed * temp_output_27_0_g11860 ) );
				#else
				float2 staticSwitch73_g11860 = _TextureLayer2Offset;
				#endif
				float2 temp_output_72_0_g11860 = ( ( _TextureLayer2Scale * temp_output_41_0_g11812 ) - staticSwitch73_g11860 );
				float2 temp_cast_82 = (_TextureLayer2EdgeClip).xx;
				float2 UV10_g11861 = ( ( ( ( ( ( ( ( ( temp_output_72_0_g11860 % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) ) - float2( 0.5,0.5 ) ) * ( float2( 1,1 ) - temp_cast_82 ) ) + float2( 0.5,0.5 ) ) % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) );
				int Width10_g11861 = _TextureLayer2Columns;
				int Height10_g11861 = _TextureLayer2Rows;
				float Tile10_g11861 = round( ( ( _TextureLayer2Speed * temp_output_27_0_g11860 ) + _TextureLayer2StartFrame ) );
				...
				#endif
				float4 tex2DNode3_g11860 = tex2D( _TextureLayer2Texture, staticSwitch20_g11860 );
				float3 appendResult13_g11860 = (float3(tex2DNode3_g11860.r , tex2DNode3_g11860.g , tex2DNode3_g11860.b));
				float3 appendResult18_g11860 = (float3(_TextureLayer2Color.r , _TextureLayer2Color.g , _TextureLayer2Color.b));
				...
				float3 staticSwitch84_g11860 = ( pow( max( ( ( break2_g11862.x + break2_g11862.x + break2_g11862.y + break2_g11862.y + break2_g11862.y + break2_g11862.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer2Contrast , 0.0001 ) ) * temp_output_16_0_g11860 );
				#else
				float3 staticSwitch84_g11860 = temp_output_16_0_g11860;
				#endif
				float3 lerpResult12_g11860 = lerp( appendResult11_g11860 , staticSwitch84_g11860 , ( tex2DNode3_g11860.a * _TextureLayer2Fade ));
				...
				#endif
				float4 temp_output_473_0 = staticSwitch15_g11860;
				#ifdef _ENABLEFULLDISTORTION_ON
				float4 break4_g11868 = temp_output_473_0;
				float fullDistortionAlpha164 = _FullDistortionFade;
				float4 appendResult5_g11868 = (float4(break4_g11868.r , break4_g11868.g , break4_g11868.b , ( break4_g11868.a * fullDistortionAlpha164 )));
				float4 staticSwitch77 = appendResult5_g11868;
				#else
				float4 staticSwitch77 = temp_output_473_0;
				#endif
				#ifdef _ENABLEDIRECTIONALDISTORTION_ON
				float4 break4_g11869 = staticSwitch77;
				float directionalDistortionAlpha167 = (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g11668 ) ):( clampResult154_g11668 ));
				float4 appendResult5_g11869 = (float4(break4_g11869.r , break4_g11869.g , break4_g11869.b , ( break4_g11869.a * directionalDistortionAlpha167 )));
				float4 staticSwitch75 = appendResult5_g11869;
				#else
				float4 staticSwitch75 = staticSwitch77;
				#endif
				float4 temp_output_1_0_g11870 = staticSwitch75;
				float4 temp_output_1_0_g11871 = temp_output_1_0_g11870;
#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float temp_output_53_0_g11871 = max( _FullAlphaDissolveWidth , 0.001 );
				#endif
				float2 temp_output_18_0_g11870 = shaderPosition235;
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float linValue16_g11872 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11870 * _FullAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11872 = MyCustomExpression16_g11872( linValue16_g11872 );
				float clampResult17_g11871 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g11871 ) ) - localMyCustomExpression16_g11872 ) / temp_output_53_0_g11871 ) , 0.0 , 1.0 );
				float4 appendResult3_g11871 = (float4((temp_output_1_0_g11871).rgb , ( temp_output_1_0_g11871.a * clampResult17_g11871 )));
				float4 staticSwitch3_g11870 = appendResult3_g11871;
				#else
				float4 staticSwitch3_g11870 = temp_output_1_0_g11870;
				#endif
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float linValue16_g11880 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11870 * _FullGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11880 = MyCustomExpression16_g11880( linValue16_g11880 );
				float temp_output_5_0_g11879 = localMyCustomExpression16_g11880;
				float temp_output_61_0_g11879 = step( temp_output_5_0_g11879 , _FullGlowDissolveFade );
				float temp_output_53_0_g11879 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g11879 = staticSwitch3_g11870;
				float4 appendResult3_g11879 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g11879 - step( temp_output_5_0_g11879 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g11879 ) ) - temp_output_53_0_g11879 ) ) ) ) + (temp_output_1_0_g11879).rgb ) , ( temp_output_1_0_g11879.a * temp_output_61_0_g11879 )));
				float4 staticSwitch5_g11870 = appendResult3_g11879;
				#else
				float4 staticSwitch5_g11870 = staticSwitch3_g11870;
				#endif
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 temp_output_1_0_g11881 = staticSwitch5_g11870;
				float2 temp_output_76_0_g11881 = temp_output_18_0_g11870;
				float linValue16_g11882 = tex2D( _UberNoiseTexture, ( temp_output_76_0_g11881 * _SourceAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11882 = MyCustomExpression16_g11882( linValue16_g11882 );
				float clampResult17_g11881 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g11881 ) + ( localMyCustomExpression16_g11882 * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11881 = (float4((temp_output_1_0_g11881).rgb , ( temp_output_1_0_g11881.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g11881 ) ):( clampResult17_g11881 )) )));
				float4 staticSwitch8_g11870 = appendResult3_g11881;
				#else
				float4 staticSwitch8_g11870 = staticSwitch5_g11870;
				#endif
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float2 temp_output_90_0_g11877 = temp_output_18_0_g11870;
				float linValue16_g11878 = tex2D( _UberNoiseTexture, ( temp_output_90_0_g11877 * _SourceGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11878 = MyCustomExpression16_g11878( linValue16_g11878 );
				float temp_output_65_0_g11877 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g11877 ) + ( localMyCustomExpression16_g11878 * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g11877 = step( temp_output_65_0_g11877 , _SourceGlowDissolveFade );
				float temp_output_76_0_g11877 = step( temp_output_65_0_g11877 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g11877 = staticSwitch8_g11870;
				float4 appendResult3_g11877 = (float4(( ( max( ( temp_output_75_0_g11877 - temp_output_76_0_g11877 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g11877).rgb ) , ( temp_output_1_0_g11877.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g11877 ) ):( temp_output_75_0_g11877 )) )));
				float4 staticSwitch9_g11870 = appendResult3_g11877;
				#else
				float4 staticSwitch9_g11870 = staticSwitch8_g11870;
				#endif
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 temp_output_1_0_g11873 = staticSwitch9_g11870;
				float2 temp_output_161_0_g11873 = temp_output_18_0_g11870;
				float3 rotatedValue136_g11873 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g11873 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11873 = rotatedValue136_g11873;
				float linValue16_g11874 = tex2D( _UberNoiseTexture, ( temp_output_161_0_g11873 * _DirectionalAlphaFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11874 = MyCustomExpression16_g11874( linValue16_g11874 );
				float clampResult154_g11873 = clamp( ( ( break130_g11873.x + break130_g11873.y + _DirectionalAlphaFadeFade + ( localMyCustomExpression16_g11874 * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11873 = (float4((temp_output_1_0_g11873).rgb , ( temp_output_1_0_g11873.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g11873 ) ):( clampResult154_g11873 )) )));
				float4 staticSwitch11_g11870 = appendResult3_g11873;
				#else
				float4 staticSwitch11_g11870 = staticSwitch9_g11870;
				#endif
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float2 temp_output_171_0_g11875 = temp_output_18_0_g11870;
				float3 rotatedValue136_g11875 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g11875 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11875 = rotatedValue136_g11875;
				float linValue16_g11876 = tex2D( _UberNoiseTexture, ( temp_output_171_0_g11875 * _DirectionalGlowFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11876 = MyCustomExpression16_g11876( linValue16_g11876 );
				float temp_output_168_0_g11875 = max( ( ( break130_g11875.x + break130_g11875.y + _DirectionalGlowFadeFade + ( localMyCustomExpression16_g11876 * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g11875 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11875 ) ):( temp_output_168_0_g11875 )) );
				float4 temp_output_1_0_g11875 = staticSwitch11_g11870;
				float clampResult154_g11875 = clamp( temp_output_161_0_g11875 , 0.0 , 1.0 );
				float4 appendResult3_g11875 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g11875 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11875 ) ):( temp_output_168_0_g11875 )) ) ) ) + (temp_output_1_0_g11875).rgb ) , ( temp_output_1_0_g11875.a * clampResult154_g11875 )));
				float4 staticSwitch15_g11870 = appendResult3_g11875;
				#else
				float4 staticSwitch15_g11870 = staticSwitch11_g11870;
				#endif
				#ifdef _ENABLEHALFTONE_ON
				float4 temp_output_1_0_g11883 = staticSwitch15_g11870;
				float2 temp_output_126_0_g11883 = temp_output_18_0_g11870;
				float temp_output_121_0_g11883 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g11883 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g11884 = (float2(temp_output_121_0_g11883 , temp_output_121_0_g11883));
				float temp_output_17_0_g11884 = length( ( (( ( abs( temp_output_126_0_g11883 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g11884 ) );
				float clampResult17_g11883 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g11884 ) / fwidth( temp_output_17_0_g11884 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11883 = (float4((temp_output_1_0_g11883).rgb , ( temp_output_1_0_g11883.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g11883 ) ):( clampResult17_g11883 )) )));
				float4 staticSwitch13_g11870 = appendResult3_g11883;
				#else
				float4 staticSwitch13_g11870 = staticSwitch15_g11870;
				#endif
				#ifdef _ENABLEADDCOLOR_ON
				float3 temp_output_3_0_g11886 = (_AddColorColor).rgb;
				float2 uv_AddColorMask = IN.texcoord.xy * _AddColorMask_ST.xy + _AddColorMask_ST.zw;
				float4 tex2DNode19_g11886 = tex2D( _AddColorMask, uv_AddColorMask );
				#ifdef _ADDCOLORMASKTOGGLE_ON
				float3 staticSwitch16_g11886 = ( temp_output_3_0_g11886 * ( (tex2DNode19_g11886).rgb * tex2DNode19_g11886.a ) );
				#else
				float3 staticSwitch16_g11886 = temp_output_3_0_g11886;
				#endif
				float4 temp_output_1_0_g11886 = staticSwitch13_g11870;
				float4 break2_g11888 = temp_output_1_0_g11886;
				#ifdef _ADDCOLORCONTRASTTOGGLE_ON
				float3 staticSwitch17_g11886 = ( staticSwitch16_g11886 * pow( max( ( ( break2_g11888.x + break2_g11888.x + break2_g11888.y + break2_g11888.y + break2_g11888.y + break2_g11888.z ) / 6.0 ) , 0.0001 ) , max( _AddColorContrast , 0.0001 ) ) );
				#else
				float3 staticSwitch17_g11886 = staticSwitch16_g11886;
				#endif
				float4 appendResult6_g11886 = (float4(( ( staticSwitch17_g11886 * _AddColorFade ) + (temp_output_1_0_g11886).rgb ) , temp_output_1_0_g11886.a));
				float4 staticSwitch5_g11885 = appendResult6_g11886;
				#else
				float4 staticSwitch5_g11885 = staticSwitch13_g11870;
				#endif
				#ifdef _ENABLEALPHATINT_ON
				float4 temp_output_1_0_g11889 = staticSwitch5_g11885;
				float3 lerpResult4_g11889 = lerp( (temp_output_1_0_g11889).rgb , (_AlphaTintColor).rgb , ( ( 1.0 - temp_output_1_0_g11889.a ) * step( _AlphaTintMinAlpha , temp_output_1_0_g11889.a ) * _AlphaTintFade ));
				float4 appendResult13_g11889 = (float4(lerpResult4_g11889 , temp_output_1_0_g11889.a));
				float4 staticSwitch11_g11885 = appendResult13_g11889;
				#else
				float4 staticSwitch11_g11885 = staticSwitch5_g11885;
				#endif
				#ifdef _ENABLESTRONGTINT_ON
				float4 temp_output_1_0_g11890 = staticSwitch11_g11885;
				float3 temp_output_6_0_g11890 = (_StrongTintTint).rgb;
				float2 uv_StrongTintMask = IN.texcoord.xy * _StrongTintMask_ST.xy + _StrongTintMask_ST.zw;
				float4 tex2DNode23_g11890 = tex2D( _StrongTintMask, uv_StrongTintMask );
				#ifdef _STRONGTINTMASKTOGGLE_ON
				float3 staticSwitch21_g11890 = ( temp_output_6_0_g11890 * ( (tex2DNode23_g11890).rgb * tex2DNode23_g11890.a ) );
				#else
				float3 staticSwitch21_g11890 = temp_output_6_0_g11890;
				#endif
				float4 break2_g11892 = temp_output_1_0_g11890;
				#ifdef _STRONGTINTCONTRASTTOGGLE_ON
				float3 staticSwitch22_g11890 = ( pow( max( ( ( break2_g11892.x + break2_g11892.x + break2_g11892.y + break2_g11892.y + break2_g11892.y + break2_g11892.z ) / 6.0 ) , 0.0001 ) , max( _StrongTintContrast , 0.0001 ) ) * staticSwitch21_g11890 );
				#else
				float3 staticSwitch22_g11890 = staticSwitch21_g11890;
				#endif
				float3 lerpResult7_g11890 = lerp( (temp_output_1_0_g11890).rgb , staticSwitch22_g11890 , _StrongTintFade);
				float4 appendResult9_g11890 = (float4(lerpResult7_g11890 , (temp_output_1_0_g11890).a));
				float4 staticSwitch7_g11885 = appendResult9_g11890;
				#else
				float4 staticSwitch7_g11885 = staticSwitch11_g11885;
				#endif
				float4 temp_output_2_0_g11893 = staticSwitch7_g11885;
				#ifdef _ENABLESHADOW_ON
				...
				float temp_output_32_0_g11895 = ( break4_g11895.a + temp_output_11_0_g11895 );
				float4 appendResult18_g11895 = (float4(( ( ( appendResult5_g11895 * break4_g11895.a ) + ( appendResult7_g11895 * temp_output_11_0_g11895 ) ) * ( 1.0 / max( temp_output_32_0_g11895 , 0.01 ) ) ) , temp_output_32_0_g11895));
				float4 staticSwitch82_g11893 = appendResult18_g11895;
				#else
				float4 staticSwitch82_g11893 = temp_output_2_0_g11893;
				#endif
				float4 break4_g11896 = staticSwitch82_g11893;
				#ifdef _ENABLECUSTOMFADE_ON
				float staticSwitch8_g11754 = 1.0;
				#else
				float staticSwitch8_g11754 = IN.color.a;
				#endif
				#ifdef _ENABLESMOKE_ON
				float staticSwitch9_g11754 = 1.0;
				#else
				float staticSwitch9_g11754 = staticSwitch8_g11754;
				#endif
				float customVertexAlpha193 = staticSwitch9_g11754;
				float4 appendResult5_g11896 = (float4(break4_g11896.r , break4_g11896.g , break4_g11896.b , ( break4_g11896.a * customVertexAlpha193 )));
				float4 temp_output_344_0 = appendResult5_g11896;
				...
				float4 staticSwitch143 = staticSwitch342;
				#endif
				float4 temp_output_7_0_g11904 = staticSwitch143;
				#ifdef _BAKEDMATERIAL_ON
				float4 appendResult2_g11904 = (float4(( (temp_output_7_0_g11904).rgb / max( temp_output_7_0_g11904.a , 1E-05 ) ) , temp_output_7_0_g11904.a));
				float4 staticSwitch6_g11904 = appendResult2_g11904;
				#else
				float4 staticSwitch6_g11904 = temp_output_7_0_g11904;
				#endif
				
				fixed4 c = staticSwitch6_g11904;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
Node;AmplifyShaderEditor.FunctionNode;365;-372.9774,-3275.82;Inherit;False;_UberInteractive;528;;11663;f8a4d7008519ad249b29e4a9381f963f;0;2;9;FLOAT;0;False;3;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;79;-47.4363,-2946.944;Inherit;False;_FullDistortion;462;;11665;62960fe27c1c398408207bb462ffd10e;0;3;195;FLOAT2;0,0;False;160;FLOAT2;0,0;False;194;SAMPLER2D;;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;81;747.3577,-2918.135;Inherit;False;_DirectionalDistortion;450;;11668;30e6ac39427ee11419083602d572972f;0;3;182;FLOAT2;0,0;False;160;FLOAT2;0,0;False;181;SAMPLER2D;;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;102;919.0109,-667.4209;Inherit;False;_GlitchPre;210;;11671;b8ad29d751d87bd4d9cbf14898be6163;0;3;19;FLOAT;0;False;18;FLOAT2;0,0;False;16;SAMPLER2D;;False;2;FLOAT;15;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;52;1839.482,-2552.931;Inherit;False;_HologramUV;203;;11673;7c71b1b031ffcbe48805e17b94671163;0;5;77;FLOAT;0;False;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;222;;11718;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;467;;11720;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;378;5475.994,-2043.135;Inherit;False;Remap2D;-1;;11732;f79f855c0a5c94649b58f3d8127375ae;0;5;13;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;6;FLOAT2;1,1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;470;6618.802,-2035.91;Inherit;False;_PixelArtUV_2;-1;;11733;4b65626ba2313ca40a96813b19044794;0;4;21;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;471;-1990.589,-315.832;Inherit;False;_UberSample;566;;11734;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;358;-1921.027,-115.7738;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;356;-1686.027,-106.7738;Inherit;False;ColorMultiply;-1;;11753;1f51da7edd80c06488c56d28bc096dec;0;2;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;343;-737.796,35.8288;Inherit;False;_UberCustomAlpha;577;;11754;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;FLOAT;12;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;551;;11759;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;361;-136.8644,-329.1863;Inherit;False;_UberColor;60;;11763;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-37.83691,-91.99512;Inherit;False;182;hologramFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;196;;11805;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;216;;11808;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;473;1656.25,-345.9998;Inherit;False;_UberEffect;227;;11812;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;78;2104.106,-267.8359;Inherit;False;AlphaMultiply;-1;;11868;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;76;3014.405,-219.2272;Inherit;False;AlphaMultiply;-1;;11869;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;390;;11870;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;478;4200.417,-206.2577;Inherit;False;_UberColorFinal;33;;11885;6ac57aba23ea6404ba71b6806ea93971;0;3;14;FLOAT2;0,0;False;15;SAMPLER2D;;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;344;4548.086,-90.46628;Inherit;False;AlphaMultiply;-1;;11896;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;546;;11897;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;512;;11900;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;340;6010.595,-19.64009;Inherit;False;BakingHandler;6;;11904;f63dfe0dc7c747c43b593d357b168fa0;0;1;7;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=BF264B58274648B195EC36F470CEBA860E91A0B7
