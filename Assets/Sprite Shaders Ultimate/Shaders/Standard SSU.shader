	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float3 To115_g12030 = ( pow( max( ( ( break2_g12031.x + break2_g12031.x + break2_g12031.y + break2_g12031.y + break2_g12031.y + break2_g12031.z ) / 6.0 ) , 0.0001 ) , max( _ColorReplaceContrast , 0.0001 ) ) * (_ColorReplaceToColor).rgb );
				...
				float4 appendResult4_g12066 = (float4(pow( max( (temp_output_1_0_g12066).rgb , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_30 ) , temp_output_1_0_g12066.a));
				...
				float3 lerpResult11_g12060 = lerp( (temp_output_1_0_g12060).rgb , ( lerpResult6_g12060 * pow( max( temp_output_3_0_g12060 , 0.0001 ) , max( _SplitToningContrast , 0.0001 ) ) ) , _SplitToningFade);
				...
				float3 lerpResult7_g12038 = lerp( temp_output_4_0_g12038 , ( temp_output_4_0_g12038 + (_BlackTintColor).rgb ) , pow( max( ( 1.0 - min( max( max( break12_g12038.r , break12_g12038.g ) , break12_g12038.b ) , 1.0 ) ) , 0.0001 ) , max( _BlackTintPower , 0.0001 ) ));
				...
				float3 lerpResult7_g12052 = lerp( (temp_output_1_0_g12052).rgb , ( (_InkSpreadColor).rgb * pow( max( ( ( break2_g12054.x + break2_g12054.x + break2_g12054.y + break2_g12054.y + break2_g12054.y + break2_g12054.z ) / 6.0 ) , 0.0001 ) , max( _InkSpreadContrast , 0.0001 ) ) ) , ( _InkSpreadFade * clampResult53_g12052 ));
				...
				#endif
				float4 appendResult6_g12048 = (float4(( ( hsvTorgb19_g12048 * pow( max( ( ( break2_g12050.x + break2_g12050.x + break2_g12050.y + break2_g12050.y + break2_g12050.y + break2_g12050.z ) / 6.0 ) , 0.0001 ) , max( _AddHueContrast , 0.0001 ) ) * staticSwitch33_g12048 ) + (temp_output_1_0_g12048).rgb ) , temp_output_1_0_g12048.a));
				...
				#endif
				float4 appendResult21_g12045 = (float4(( (temp_output_1_0_g12045).rgb + ( pow( max( ( ( break2_g12046.x + break2_g12046.x + break2_g12046.y + break2_g12046.y + break2_g12046.y + break2_g12046.z ) / 6.0 ) , 0.0001 ) , max( _SineGlowContrast , 0.0001 ) ) * staticSwitch27_g12045 * _SineGlowFade * ( ( ( sin( ( temp_output_39_0_g12026 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g12045.a));
				...
				#endif
				float temp_output_213_0_g12040 = ( _PixelOutlineFade * step( temp_output_15_0_g12040.a , _PixelOutlineAlphaLimit ) );
				float temp_output_182_0_g12040 = ( ( 1.0 - temp_output_15_0_g12040.a ) * min( ( temp_output_213_0_g12040 * 3.0 ) , 1.0 ) );
				...
				float lerpResult168_g12040 = lerp( temp_output_15_0_g12040.a , min( ( max( max( max( tex2D( _MainTex, ( temp_output_7_0_g12040 + ( ( _PixelOutlineWidth * float2( 0,-1 ) ) * temp_output_209_0_g12040 ) ) ).a , tex2D( _MainTex, ( temp_output_7_0_g12040 + ( ( _PixelOutlineWidth * float2( 0,1 ) ) * temp_output_209_0_g12040 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g12040 + ( ( _PixelOutlineWidth * float2( -1,0 ) ) * temp_output_209_0_g12040 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g12040 + ( ( _PixelOutlineWidth * float2( 1,0 ) ) * temp_output_209_0_g12040 ) ) ).a ) * 3.0 ) , 1.0 ) , temp_output_213_0_g12040);
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				...
				float4 appendResult12_g12027 = (float4(( ( lerpResult15_g12027 * _PingPongGlowFade * pow( max( ( ( break2_g12028.x + break2_g12028.x + break2_g12028.y + break2_g12028.y + break2_g12028.y + break2_g12028.z ) / 6.0 ) , 0.0001 ) , max( _PingPongGlowContrast , 0.0001 ) ) ) + (temp_output_5_0_g12027).rgb ) , temp_output_5_0_g12027.a));
				...
				float3 lerpResult4_g12105 = lerp( (temp_output_1_0_g12105).rgb , ( (lerpResult68_g12105).rgb * pow( max( ( ( break2_g12108.x + break2_g12108.x + break2_g12108.y + break2_g12108.y + break2_g12108.y + break2_g12108.z ) / 6.0 ) , 0.0001 ) , max( _CamouflageContrast , 0.0001 ) ) ) , _CamouflageFade);
				...
				#endif
				float4 lerpResult45_g12098 = lerp( temp_output_1_0_g12098 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g12101 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( max( temp_output_5_0_g12098 , 0.0001 ) , max( _MetalHighlightContrast , 0.0001 ) ) ) + ( pow( max( temp_output_5_0_g12098 , 0.0001 ) , max( _MetalContrast , 0.0001 ) ) * _MetalColor ) ) , staticSwitch60_g12098);
				...
				float3 lerpResult57_g12090 = lerp( (temp_output_1_0_g12090).rgb , ( ( pow( max( temp_output_7_0_g12090 , 0.0001 ) , max( _FrozenContrast , 0.0001 ) ) * (_FrozenTint).rgb ) + ( pow( max( temp_output_7_0_g12090 , 0.0001 ) , max( _FrozenSnowContrast , 0.0001 ) ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g12092 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g12095 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( max( temp_output_7_0_g12090 , 0.0001 ) , max( _FrozenHighlightContrast , 0.0001 ) ) )).rgb ) , _FrozenFade);
				...
				float3 lerpResult29_g12084 = lerp( temp_output_28_0_g12084 , ( pow( max( ( ( break2_g12088.x + break2_g12088.x + break2_g12088.y + break2_g12088.y + break2_g12088.y + break2_g12088.z ) / 6.0 ) , 0.0001 ) , max( _BurnInsideContrast , 0.0001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g12084 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g12084);
				...
				#endif
				float4 appendResult8_g12076 = (float4(( temp_output_57_0_g12076 + ( ( pow( max( lerpResult92_g12076 , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_70 ) * (_ShineColor).rgb ) * clampResult80_g12076 * staticSwitch98_g12076 ) ) , (temp_output_1_0_g12076).a));
				...
				float4 appendResult27_g12111 = (float4(( ( max( pow( max( abs( ( ( ( localMyCustomExpression16_g12113 + ( temp_output_41_0_g12111 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , 0.0001 ) , max( _PoisonDensity , 0.0001 ) ) , 0.0 ) * temp_output_24_0_g12111 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g12111 ) , temp_output_1_0_g12111.a));
				...
				float3 temp_output_40_0_g12115 = ( staticSwitch50_g12115 * pow( max( ( ( break2_g12117.x + break2_g12117.x + break2_g12117.y + break2_g12117.y + break2_g12117.y + break2_g12117.z ) / 6.0 ) , 0.0001 ) , max( _EnchantedContrast , 0.0001 ) ) * _EnchantedBrightness );
				...
				#endif
				float3 lerpResult31_g12120 = lerp( appendResult32_g12120 , ( staticSwitch26_g12120 * pow( max( temp_output_4_0_g12120 , 0.0001 ) , max( _ShiftingContrast , 0.0001 ) ) ) , _ShiftingFade);
				...
				float3 staticSwitch80_g12127 = ( pow( max( ( ( break2_g12129.x + break2_g12129.x + break2_g12129.y + break2_g12129.y + break2_g12129.y + break2_g12129.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer1Contrast , 0.0001 ) ) * temp_output_16_0_g12127 );
				#else
				...
				float3 staticSwitch84_g12123 = ( pow( max( ( ( break2_g12125.x + break2_g12125.x + break2_g12125.y + break2_g12125.y + break2_g12125.y + break2_g12125.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer2Contrast , 0.0001 ) ) * temp_output_16_0_g12123 );
				#else
				...
				float3 staticSwitch17_g12149 = ( staticSwitch16_g12149 * pow( max( ( ( break2_g12151.x + break2_g12151.x + break2_g12151.y + break2_g12151.y + break2_g12151.y + break2_g12151.z ) / 6.0 ) , 0.0001 ) , max( _AddColorContrast , 0.0001 ) ) );
				#else
				...
				float3 staticSwitch22_g12153 = ( pow( max( ( ( break2_g12155.x + break2_g12155.x + break2_g12155.y + break2_g12155.y + break2_g12155.y + break2_g12155.z ) / 6.0 ) , 0.0001 ) , max( _StrongTintContrast , 0.0001 ) ) * staticSwitch21_g12153 );
				#else
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;222;;11777;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;467;;11779;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;489;-1990.589,-315.832;Inherit;False;_UberSample;566;;11874;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;343;-737.796,35.8288;Inherit;False;_UberCustomAlpha;577;;11894;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;FLOAT;12;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;148;-614.0953,-401.0159;Inherit;False;146;finalUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;551;;11899;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;196;;12068;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;216;;12071;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;473;1656.25,-345.9998;Inherit;False;_UberEffect;227;;12075;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;390;;12133;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;546;;12161;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;512;;12163;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=F44BD7D36FD79C0EA637128428093B3C85E82477
